...
**Si vous rencontrez ce problème sous Windows,** veuillez prendre contact avec C. Kaiser. Si le problème est réglé, cliquez sur [le lien suivant](#ajouter-une-couche-vectorielle) pour continuer le tutoriel. Sinon, nous vous proposons une deuxième solution ci-dessous.

#### Deuxième solution possible pour le bug
